...
// - reward strategy: staked luserl/totalStaked distribution

// - signer block 0 staking
// - signer block 5 staking
// - 0-- 1-- 2-- 3-- 4-- 5--
//   |                   |
...
contract TinyBank {
    ...
    function distributeReward(address to) internal {
        if (totalStaked == 0) return; // Error: VM Exception while processing transaction: reverted with panic code 0x12 (Division or modulo division by zero)
